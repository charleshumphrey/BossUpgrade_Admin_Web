                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:cursor-pointer">
                            ...
                            <td class="border border-gray-200">
                                <button type="submit" class="button bg-green-500 text-white px-4 py-2 rounded --jb-modal" data-target="confirm-modal{{$order['orderId']}}">Out for Delivery</button>
                        ...
                        <div id="confirm-modal{{ $order['orderId'] }}" class="modal hidden">
                            ...
                            <div class="modal-card">
                                <header class="modal-card-head">
                                    ...
                                    <p class="modal-card-title text-black">Out For Delivery <span class="text-green-500">Order</span></p>
                                </header>
                                <section class="modal-card-body text-gray-700">
                                    <p>Are you sure you want to <span class="text-green-500">deliver</span> this order?</p>
                                </section>
                                <footer class="modal-card-foot justify-end">
                                    <button id="cancel-archive" class="button --jb-modal-close">Cancel</button>
                                    <form action="{{ route('orders.fordelivery', $order['orderId']) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
